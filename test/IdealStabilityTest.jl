...
test_ideal_stability(Bp, Bt, dpdr, R0, r0, rb;verbose=true, ignore_Suydam=true, m1ncap=20)

test_ideal_stability(Bpc, Btc, dpdrc, R0, r0, rb;verbose=true, ignore_Suydam=false)
test_ideal_stability(Bp_s50, Bt_s50, dpdr_s50, R0, r0, rb;verbose=true, ignore_Suydam=true, m0ncap=5, m1ncap=20)
